...
const dictionaryData = [
    ...
    { 
        ...
        definition: `
            ...
            <ul>
                <li><strong>시가:</strong> 아침 9시, 주식 시장이 열렸을 때의 '시작 가격'</li>
                <li><strong>종가:</strong> 오후 3시 30분, 시장이 닫혔을 때의 '마지막 가격'</li>
                <li><strong>고가:</strong> 하루 중 가장 높게 올라갔던 '최고 가격'</li>
                <li><strong>저가:</strong> 하루 중 가장 낮게 내려갔던 '최저 가격'</li>
            </ul>
            <h4>빨간색(양봉) vs 파란색(음봉)</h4>
            <p>캔들의 색깔은 '시가'와 '종가'가 결정해요.</p>
            <ul>
                <li><strong>🔴 양봉 (빨간색):</strong> 종가가 시가보다 높게 끝났다는 뜻! 즉, '사려는 힘'이 이겨서 주가가 오른 날이에요.</li>
                <li><strong>🔵 음봉 (파란색):</strong> 종가가 시가보다 낮게 끝났다는 뜻! 즉, '팔려는 힘'이 이겨서 주가가 내린 날이에요.</li>
            </ul>
            <h4>몸통과 꼬리</h4>
            <p>캔들은 통통한 '몸통'과 얇은 '꼬리'로 이루어져 있어요.</p>
            <ul>
                <li><strong>몸통:</strong> 시가와 종가 사이의 가격 범위를 보여줘요. 몸통이 길수록 그날의 주가 변동이 컸다는 뜻!</li>
                <li><strong>꼬리:</strong> 몸통 위아래로 삐죽 나온 선이에요. 위꼬리는 그날의 '고가'를, 아래꼬리는 '저가'를 나타내죠. 꼬리가 길다는 건, 장중에 주가가 엄청나게 오르거나 내렸었다는 흔적이에요.</li>
            </ul>
        `
    }
];
